...
spectre_attack_df = dataset[dataset['class']==1][0:200]
no_spectre_attack_df = dataset[dataset['class']==0][0:200]
...
#print(X_test.shape)
# shape of X_train, 26x553
# shape of y_train, 26x1
#shape of X_test, 7x553
#shape of y_test, 7x1
